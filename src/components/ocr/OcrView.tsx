...
export default function OcrView({
  ...
  cameraInputRef, batchOcr, onNavigateToLibrary, audio, onAudioSave, audioSaving,
}: Props) {
    ...
    <div className="p-4 sm:p-6 lg:p-8 animate-fade-in">
      <div className="flex flex-col lg:grid lg:grid-cols-2 lg:gap-8 lg:items-start gap-6">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex gap-1 p-1 bg-surface/60 rounded-xl border border-white/8 self-start mb-4">
            <button

  ...
  return (
    <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-glass">
      ...
      <button
        ...
        className="absolute top-3 right-3 w-8 h-8 rounded-full bg-black/50 backdrop-blur-sm border border-white/12 hover:bg-err/70 hover:border-err/50 text-ink/80 hover:text-white flex items-center justify-center transition-all"
      >
